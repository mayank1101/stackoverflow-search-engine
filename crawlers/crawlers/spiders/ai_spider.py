"""
ai_spider.py
Scrapy spider to scrape tags, questions, and stats from http://ai.stackexchange.com/.
"""
...
class AISpider(scrapy.Spider):
    """
    Spider class that navigates the Artificial Intelligence StackExchange site,
